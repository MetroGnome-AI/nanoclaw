...
// Configurable via NANOCLAW_IDLE_CEILING_MS (integer milliseconds, read from the
// process environment or .env). Unset or invalid values keep the default. (Fork patch.)
